...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-[0.75rem] border border-white/8 bg-[#181818] px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}
    >
          ...
          return (
            ...
            >
                ...
                !hideIndicator && (
                  <div
                    className={cn(
                      ...
                      indicator === "dot" && "mt-0.5 h-2 w-2 rounded-full",
                      indicator === "line" && "w-1",
              ...
              >
                <div className="grid gap-1.5">
                  {nestLabel ? tooltipLabel : null}
                  <span className="text-[var(--seva-text-muted,rgba(240,238,235,0.5))]">
